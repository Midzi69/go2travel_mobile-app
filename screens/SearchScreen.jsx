...
const SearchScreen = () => {
  ...
  const data = [
...

    {
      id: "4",
      place: "New York",
      placeImage: "https://images.pexels.com/photos/2190283/pexels-photo-2190283.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
      shortDescription: "City in New York, United States",
      properties: [
        {
          id: "40",
          name: "The Ritz-Carlton New York, Central Park",
          image:"https://cf.bstatic.com/xdata/images/hotel/max1024x768/482620202.jpg?k=ab59fa0eeee2529ff6c9e5efdef48ee28c9bce51b849a5576dacaca5f44d68e1&o=&hp=1",
          rating: 4.9,
          address: "50 Central Park South, Midtown West, New York, NY 10019, United States",
          oldPrice: 9500,
          newPrice: 8000,
          latitude: "40.766122",
          longitude: "-73.979723",
          photos: [
            ...
            {
              id: "201",
              image: "https://cf.bstatic.com/xdata/images/hotel/max1024x768/482619178.jpg?k=7bebd255e5b18c6fa8bbbc5494853c2426aafb1c4361e66b72a0426310db2e6c&o=&hp=1"
            }
          ],
          rooms: [
            {
              id: "400",
              name: "Luxury Suite with Park View",
              size: 750,
              refundable: "refundable",
              payment: "Pay at the property",
              bed: "1 king bed"
        ...
        },
        {
          ...
          image:"https://cf.bstatic.com/xdata/images/hotel/max1024x768/488854363.jpg?k=63f4f54eb2cde603d2c10efd28395edf8330335b229c8b77926defe1501588c6&o=&hp=1",
          rating: 4.7,
          address: "27 Barclay Street, Tribeca, New York, NY 10007, United States",
          oldPrice: 8200,
          newPrice: 6900,
          latitude: "40.712276",
          longitude: "-74.008295",
          photos: [
            ...
            {
              id: "203",
              image: "https://cf.bstatic.com/xdata/images/hotel/max1024x768/488854370.jpg?k=f8904697c2fe39e49cc0f4953b479204e6c29d4e06e172c001fc48b67dee2c20&o=&hp=1"
            }
          ],
          rooms: [
            {
...

    {
      id: "5",
      place: "Tokyo",
      placeImage: "https://images.pexels.com/photos/2303337/pexels-photo-2303337.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
      shortDescription: "City in Tokyo, Japan",
      properties: [
        {
          id: "50",
          name: "Park Hyatt Tokyo",
          image:"https://cf.bstatic.com/xdata/images/hotel/max1024x768/143277621.jpg?k=6560602075b20951ae105546c2f407566a8999ba1f5ad97e92e3f8470337d484&o=&hp=1",
          rating: 4.8,
          ...
          photos: [
            ...
            {
              id: "221",
              image: "https://cf.bstatic.com/xdata/images/hotel/max1024x768/14107253.jpg?k=c0a9cbaaccc7d8283958e21d30a59ad36deb85fa55bf85be45bb8999591388d7&o=&hp=1"
            }
          ],
          rooms: [
            {
        ...
        {
          id: "51",
          name: "Hotel New Otani Tokyo Garden Tower",
          image:"https://cf.bstatic.com/xdata/images/hotel/max1024x768/148776806.jpg?k=eefe644f0e824588cf0d9dce4353dd2a84c5ac65712134436f7ad3f361c6662c&o=&hp=1",
          rating: 4.6,
          ...
          photos: [
            ...
            {
              id: "223",
              image: "https://cf.bstatic.com/xdata/images/hotel/max1024x768/148776792.jpg?k=00bd2150feb902dc2a56831ece88c7b0b47b4d2082323f1bf3f75cc68aac0fb6&o=&hp=1"
            }
          ],
          rooms: [
            {
  ...
  return (
    <SafeAreaView>
      <View style={{ padding: 10, margin: 10, flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderColor: "#FFC72C", borderWidth: 4, borderRadius: 10 }}>
        <TextInput value={input} onChangeText={(text) => setInput(text)} placeholder='Enter Your Destination(eg. New York): ' />
